...
#use the tabulate library to print the first 50 rows of the mac_list, port_list, and vendor_list to a table
print("\n[yellow]===[/yellow] The first 25 rows of the [bright_red]CSV[/bright_red] file are: [yellow]===[/yellow]\n")
print(tabulate(zip(mac_list[:25], port_list[:25], vendor_list[:25]), headers=["MAC Address", "Port", "Vendor Name"]))
