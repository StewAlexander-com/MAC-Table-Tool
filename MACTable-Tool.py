...
#Try to update the requests library
try:
...
#Try to update the tqdm library
try:
...
#Try to update the tabular library
try:
    subprocess.call([sys.executable, "-m", "pip", "install", "--upgrade", "tabulate"])
    time.sleep(10)
    from tabulate import tabulate
except:
    pass
